...
window.title("Python Project On Skin Disease Detection Using Convolutional Neural Network (CNN)")

window.config(background = "saddle brown")

window.iconbitmap(default='main.ico')

li = Label(window, text ='Python Project On Skin Disease Detection Using Convolutional Neural Network (CNN)' ,font='cambria 22 bold italic',bg = "saddle brown",fg = "yellow")
...
bi1 = Button(window,text='BROWSE IMAGE',width=14, borderwidth = 1, bg='cyan', fg='gray1', command=ipim,font='cambria 17 bold italic')

bi1.place(x=880, y=140)

bi2 = Button(window, text='DETECT DISEASE', borderwidth = 1,width=14,   bg='cyan',fg='gray1', command=process,font='cambria 17 bold italic')

bi2.place(x=880, y=240)

bi3 = Button(window, text='RESET', borderwidth = 1,  bg='cyan',fg='gray1',width=14, command=grosp,font='cambria 17 bold italic')

bi3.place(x=880, y=340)

bi4 = Button(window,text='EXIT', borderwidth = 1,   bg='cyan',fg='gray1',width=14, command=window.destroy,font='cambria 17 bold italic')
